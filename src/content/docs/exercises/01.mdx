...
1. You can see this in the demo repo:
...
1. In your terminal, make sure the component library is running.
...
1. Visit the sample USWDS page template.
...
1. Next, go back to your terminal and stop the task or open a new terminal tab and compile the styles.
...
1. First, let's identify the components we have on the page. We have banner, hero, footer among others.
...
1. Run the build command again and see that your styles are much leaner too.
    ...
    The `index.css` file should be `149KB` now, saving _416KB_ from our original.
