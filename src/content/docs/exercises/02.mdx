...
1. Run the build command again and see that your styles are much leaner too.
    ...
    The `index.css` file should be `149KB` now, down 416 KB from our original. Not only do you get faster builds and leaner styles, but now you're setup to be able to extend!
</Steps>
