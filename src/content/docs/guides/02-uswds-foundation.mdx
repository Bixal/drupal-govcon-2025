...
The **21st Century IDEA act** requires teams to create digital-first experiences for the public that are accessible, user-centered, plain language, and more. Meeting these requirements can be _a lot_ of work. A lot of this already aligns with USWDS principles.
