...
![The USWDS landing page using the default blue and gray theme colors](/src/assets/uswds-landing-2025-07-30@2x.webp)
...
![The USWDS landing page now in light gray and an indigo based color scheme](/src/assets/uswds-landing-base-theme@2x.webp)
...
4.  #### Customizing the Child Theme
    ...
    ![The USWDS landing page extended from previous scheme, but using violet as the primary color](/src/assets/uswds-landing-extended-theme@2x.webp)
