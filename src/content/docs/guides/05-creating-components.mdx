...
<Card title="Anatomy of a USWDS Component" icon="seti:smarty">
  ...
  **Structure**: Components should be modular and easily integrated with other
  parts of the design system. - **Props**: Define a clear API with
  well-documented props and modifiers. - **Documentation**: Provide
  comprehensive documentation, including usage examples, props tables, and
  design guidelines.
</Card>
...
- **Principles**: Remember to follow your established design principles to guide the development of the component.
