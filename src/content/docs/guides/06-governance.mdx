...
<figure>
  <img
    src={metricsScreenshot.src}
    aria-describedby="metrics-screenshot"
    alt=""
  />
...
- [Sample Sprint Retrospective Template](/templates/sprint-retrospective)
- [ADR Template](/templates/adr)
- [Metrics Spreadsheet | GDocs](https://docs.google.com/spreadsheets/d/1RwdX20S3qS5nLarMouSGc1ID5xcWuJfsy9fU_Kk3EjI/)
- [USWDS Decisions (ADRs) | GitHub](https://github.com/uswds/uswds-proposals/tree/main/decisions)
- [Contribute to USWDS | USWDS](https://designsystem.digital.gov/about/contribute/)
- [USWDS Release Notes | GitHub](https://github.com/uswds/uswds/releases)
- Changelogs
  - [Banner Changelog | USWDS](https://designsystem.digital.gov/components/banner/#latest-updates)
  - [Settings Changelog | USWDS](https://designsystem.digital.gov/documentation/settings/#latest-updates)
